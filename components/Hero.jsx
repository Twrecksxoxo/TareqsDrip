    ...
    return (
        <div className='mx-6'>
            <div className='flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10'>
                <div className='relative flex-1 flex flex-col bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl xl:min-h-100 group border border-pink-500/30 overflow-hidden shadow-xl hover:shadow-2xl hover:shadow-pink-500/20 transition-all duration-500 glow-effect'>
